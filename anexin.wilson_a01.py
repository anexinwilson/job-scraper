...
results = itjobs_soup.find(id ='search-results')
# print(results)
itjobs_cards = results.find_all('div',class_='details_wrapper')
itjob_position = results.find('a', class_='offer-name')


for itjob in itjobs_cards:
    itjob_position = itjob.find('a', class_='offer-name')
    itjob_company = itjob.find('a', class_='company')
    itjob_location = itjob.find('a', class_='location')
    itjob_description = itjob.find('p', class_ = 'offer-description')
